...
- Environmental Performance Index (EPI)
    - A scoring system by Yale and Columbia to rank 180 countries on climate change performance, environmental health, and ecosystem vitality
...
1. Nominal borrowing amounts for GS bonds follow an upward trend.
...
2. There is a regional (and global) drop in EPI scores, followed by a slight recovery in 2024.
...
3. In the South Korea example, we can see that EPI scores remain stagnant despite a rise in GS bond issuance volume.
