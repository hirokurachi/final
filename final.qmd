...
df_asean3_average = calc_annual_average(
    df_index[df_index["Country Name"] != "World average"], "ASEAN+3 average")
...
countries_index = df_index[~df_index["Country Name"].isin(["World average", "ASEAN+3 average"])][["Country Name", "iso"]].value_counts().reset_index(
).sort_values(
    by="iso", 
    ascending=True
